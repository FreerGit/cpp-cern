...
//     -DCMAKE_EXE_LINKER_FLAGS="-fsanitize=address" . Note: If you reconfigure everything, all
//     other exercises will also be built with asan instrumentation!
...
// - After you fixed the problem in Task 1, asan should immediately point to the function below. Try
// it.
